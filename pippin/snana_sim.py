...
class SNANASimulation(ConfigBasedExecutable):
    def __init__(self, name, output_dir, dependencies, genversion, config, global_config, combine="combine.input"):
        self.data_dir = os.path.dirname(inspect.stack()[0][1]) + "/data_files/"
        super().__init__(name, output_dir, dependencies, self.data_dir + combine, ":")
