...
def add_muref(df, filename, alpha=0.14, beta=3.1, om=0.311, h0=70, MB=-19.361) -> None:
...
if __name__ == "__main__":
    ...
    try:
        ...
        data_dfs = list(map(load_file, args.get("DATA_FITRES_INPUT", []), args.get("DATA_FITRES_PARSED", [])))
        sim_dfs = list(map(load_file, args.get("SIM_FITRES_INPUT", []), args.get("SIM_FITRES_PARSED", [])))
