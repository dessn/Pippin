...
class NearestNeighborPyClassifier(Classifier):
    ...
    def __init__(self, name, output_dir, dependencies, mode, options, index=0):
        ...
        self.features = options.get("FEATURES", "zHD x1 c cERR x1ERR mBERR COV_x1_c COV_x1_x0 COV_c_x0 PKMJDERR")
...
"""
    ...
    def predict(self, force_refresh):
        ...
        types = self.get_simulation_dependency().output["types_dict"]["IA"]
        command = (
            f"-p "
